...
<div class="container mt-5">
		...
		<form action="reportaccess.do" method="post">
			<input type="hidden" name="qna_no" value="${qnaboard.qna_no}">
			<input type="hidden" name="category_no" value="${qnaboard.category_no}">
			<input type="hidden" name="qna_nick" value="${qnaboard.qna_nick}">
			<input type="hidden" name="qna_subject" value="${qnaboard.qna_subject}">
