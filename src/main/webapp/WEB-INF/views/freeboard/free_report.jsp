...
<div class="container mt-5">
		...
		<form action="reportaccess.free" method="post">
			<input type="hidden" name="free_no" value="${freeboard.free_no}">
			<input type="hidden" name="category_no" value="${freeboard.category_no}">
			<input type="hidden" name="free_nick" value="${freeboard.free_nick}">
			<input type="hidden" name="free_subject" value="${freeboard.free_subject}">
